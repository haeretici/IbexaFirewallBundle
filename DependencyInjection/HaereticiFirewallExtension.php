 ...
 */
class HaereticiFirewallExtension extends Extension implements PrependExtensionInterface
{
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('haeretici_firewall.defaults', $processedConfig);
    }
